...
var (
	userAllColumns            = []string{"id", "name", "password", "email", "phone", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"id", "name", "password", "email", "phone", "created_at", "updated_at"}
